...
<div className="rounded-[32px] border border-white/10 bg-white/5 backdrop-blur-sm p-10 lg:p-7 lg:rounded-2xl"><div className="mb-3 text-xs uppercase tracking-[0.35em] text-violet-300 lg:mb-2 lg:text-[10px]">Why We Exist</div><h2 className="text-3xl font-bold lg:text-2xl">Our Mission</h2>
  ...
  <div className="mt-8 rounded-3xl border border-violet-500/30 bg-violet-500/10 p-8 text-center lg:p-6 lg:mt-6 lg:rounded-2xl">
    <p className="text-2xl font-bold text-violet-300 lg:text-xl">Deliver simplicity where campaigns have grown accustomed to complexity.</p>
    <p className="mt-3 text-slate-300 lg:mt-2">Not for the people standing behind the podium.<br/>For the people standing behind the campaign.</p>
  </div>
</div>
...
<div>
  ...
  <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-3 lg:gap-4 lg:mt-6">
    <div className="rounded-2xl bg-white/5 p-5 lg:p-4 lg:rounded-xl">Campaign workers deserve better technology.</div>
...
<div className="space-y-10 lg:space-y-7">
  <div><h2 className="text-3xl font-bold lg:text-2xl">Building With Campaigns</h2><p className="mt-4 max-w-3xl text-slate-300 leading-8 lg:text-sm lg:leading-6 lg:mt-3">Every campaign teaches us something. Every conversation changes our perspective. We're not building software for campaigns—we're building it alongside them.</p></div>
  <div><h2 className="text-3xl font-bold lg:text-2xl">Beyond the Software</h2><p className="mt-4 max-w-3xl text-slate-300 leading-8 lg:text-sm lg:leading-6 lg:mt-3">Long after elections are over, the late nights, impossible deadlines, and friendships are what remain. We want Aether to honor the people behind those stories.</p></div>
  <div className="rounded-3xl border border-violet-500/30 bg-violet-500/10 p-10 text-center lg:p-7 lg:rounded-2xl">
    ...
    <p className="mt-6 text-2xl font-bold text-violet-300 lg:mt-4 lg:text-xl">Make campaign work a little simpler<br/>for the people who make campaigns possible.</p>
  </div>
</div>
...
<p className="mt-4 text-slate-400 lg:mt-3">Whether you're running for city council, managing a statewide campaign, or simply curious about what we're building, we'd love to have a conversation.</p>
<div className="mt-12 mb-8 flex justify-center lg:mt-8 lg:mb-6">
<Link href="/explore-abe" className="rounded-xl bg-violet-600 px-6 py-3 font-bold lg:px-[18px] lg:py-2.5">Request a Demo</Link>
</div>
