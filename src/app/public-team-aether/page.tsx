...
<div className="space-y-12">
  <div className="rounded-3xl bg-white/5 border border-white/10 p-8">
    ...
    <p className="mt-4 text-slate-300 leading-8">Every team needs someone willing to ask impossible questions. The Architect's obsession isn't writing software—it's removing friction. Every feature eventually comes back to one question: <strong>Does this actually make someone's day easier?</strong><br/><br/>Of course... staying on that question is another matter entirely.<br/><br/>Somewhere between solving one problem and shipping the solution, he'll inevitably wander into three new ideas, two impossible thought experiments, and one business venture that has absolutely nothing to do with campaign software. That's usually about the time everyone else reminds him what they were actually supposed to be working on.<br/><br/>Fortunately, every once in a while, one of those ridiculous detours becomes the feature that changes everything.</p>
    <blockquote className="mt-6 border-l-4 border-violet-400 pl-5 italic text-lg">"What if... hear me out... we stopped trying to make software and instead made grilled cheese sandwiches in crazy ways... and turned that into a business?"</blockquote>
  </div>

  <div className="rounded-3xl bg-white/5 border border-white/10 p-8">
    <h2 className="text-3xl font-bold">The Operator</h2>
    <p className="mt-4 text-slate-300 leading-8">Every ambitious idea eventually meets reality. That's where The Operator shines.<br/><br/>He's the one who keeps us moving when the excitement wears off. The guy who grinds through the work nobody talks about. The one willing to sit with the boring problems, the tedious details, and the long checklists because someone has to.<br/><br/>While The Architect is dreaming about tomorrow and The Mystic is reminding us why people matter, The Operator is making sure today's work actually gets finished.<br/><br/>Great ideas don't become products because they're exciting.<br/><br/>They become products because someone refuses to quit until they're real.</p>
  ...
  <div className="rounded-3xl bg-white/5 border border-white/10 p-8">
    ...
    <p className="mt-4 text-slate-300 leading-8">Technology has never been the point.<br/><br/>The Mystic isn't the one explaining APIs or debating architecture. In fact, he's usually the first to admit that half the technical conversations go completely over his head.<br/><br/>What he does understand is people.<br/><br/>He's endlessly creative, wonderfully goofy, and somehow manages to remind us that software is supposed to make people smile once in a while.<br/><br/>While the rest of us are busy discussing databases and deployments, he's the one celebrating the little moments that remind us why we're building this in the first place.</p>
    <blockquote className="mt-6 border-l-4 border-violet-400 pl-5 italic text-lg">"But like... how do I take a screenshot of this..? It's so freakin cool man!"</blockquote>
  </div>
</div>
