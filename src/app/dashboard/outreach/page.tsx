...
import { buildOutreachBriefing } from "@/lib/abe/interpreters/outreach";
import { outreachAbeReady as isOutreachAbeReady } from "@/lib/abe/readiness";
...
function OutreachPageContent() {
  ...
  const outreachAbeReady = isOutreachAbeReady({
    loading: loading || contactsLoading || logsLoading,
    orgContext: outreachOrgContext,
  });
