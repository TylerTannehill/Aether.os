...
import { buildFieldBriefing } from "@/lib/abe/interpreters/field";
import { fieldAbeReady as isFieldAbeReady } from "@/lib/abe/readiness";
import {
  getFieldMetricRows,
  type FieldMetricRow,
} from "@/lib/data/field";
...
export default function FieldDashboardPage() {
  ...
  const fieldAbeReady = isFieldAbeReady({
