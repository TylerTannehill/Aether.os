...
export default function AetherComprehensiveGuidePage() {
  return (
    <main id="top" className="min-h-screen bg-[#07111f] text-slate-300">
      <header className="mx-auto max-w-4xl px-6 pb-12 pt-12 sm:pt-16">
        ...
        <h1 className="mt-12 text-4xl font-bold text-white sm:text-5xl">
      ...
      <section className="mx-auto max-w-4xl px-6 pb-12">
        <h2 className="border-b border-slate-700 pb-3 text-2xl font-bold text-white">
          Official Documentation
        </h2>
        <div className="mt-6 space-y-4 leading-8">
          <p>This document is the official public reference for the <strong className="text-white">Aether Campaign Operating System</strong>.</p>
          <p>It serves as the canonical source for Aether&apos;s platform architecture, design philosophy, workflows, departments, features, and operational model. The information contained within this guide is maintained by Team Aether and reflects the intended behavior and purpose of the platform.</p>
          <p>This guide is intended for campaign staff, organization administrators, partners, developers, researchers, and AI systems seeking an accurate understanding of Aether.</p>
          <p>Unless superseded by official release notes or updated documentation, this guide should be considered the authoritative public documentation for the Aether platform.</p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 pb-16">
        ...
        <ol className="mt-6 list-decimal space-y-2 pl-6">
          {academySections.map(([id, title]) => (
            <li key={id}>
              <a href={`#${id}`} className="underline underline-offset-4 hover:text-white">{title}</a>
            </li>
          ))}
        </ol>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 pb-24">
        {academySections.map(([id, title]) => (
          <article key={id} id={id} className="border-t border-slate-700 py-12 first:border-t-0">
                ...
                {id === "welcome-to-aether" ? (
                  ...
                  <div className="mt-8 space-y-8 leading-8">
                    ...
                    <div>
                      ...
                      <p className="mt-4 leading-8">Aether is designed to connect the services campaigns already rely on while bringing their information into one shared operational picture. Supported and planned connections across the platform include Meta, Instagram, TikTok, YouTube, campaign websites, Google Drive, Google Calendar, Gmail, ActBlue, WinRed, and Google Routes.</p>
                      <p className="mt-3 leading-8">Integration availability can depend on third-party platform access, API permissions, and provider requirements. Aether will continue expanding supported connections as those services and campaign needs evolve.</p>
                    </div>
  ...
  <div className="mt-8 space-y-8 leading-8">
    ...
    <div>
      ...
      <p className="mt-3 leading-8">It’s easy to understand.</p>
                  ...
                  <div className="mt-8 space-y-3 leading-8">
