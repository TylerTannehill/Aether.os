                ...
                {id === "welcome-to-aether" ? (
                  ...
                  <div className="mt-8 space-y-8 leading-8">
                    ...
                    <div>
                      ...
                      <p className="mt-4 leading-8">The following integrations are live and currently supported within Aether: Google Drive, Gmail, Google Calendar, Google Routes, ActBlue, WinRed, YouTube, Meta, Instagram, TikTok, and Campaign Websites.</p>
                      <p className="mt-3 leading-8">Integration availability can depend on third-party platform access, API permissions, provider requirements, and the capabilities made available by each connected service.</p>
                    </div>
