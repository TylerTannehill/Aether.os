    ...
    <main className="min-h-screen overflow-hidden bg-[#07111f] text-white">
      <section className="relative px-6 py-8 lg:px-8 lg:px-[18px] lg:py-6">
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col gap-8 lg:gap-6">
            ...
            <div className="rounded-[2rem] border border-white/10 bg-slate-900/80 p-5 shadow-2xl lg:p-4">
              <div className="rounded-[1.7rem] bg-[#efe7ff] p-7 text-[#32106b] shadow-xl lg:p-7 lg:p-5">
                <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between lg:gap-4">
                  ...
                  <div className="rounded-2xl border border-amber-300 bg-amber-50 px-4 py-3 text-center text-sm font-black text-amber-800 lg:px-3 lg:py-2.5 lg:text-[12px] lg:rounded-xl">
                    Abe&apos;s
                    <br />
                    Brief
                  </div>
          ...
          <section className="rounded-[2rem] border border-amber-300/20 bg-[#111827] p-8 text-center shadow-2xl lg:p-7 lg:p-6">
            <p className="text-xs font-black uppercase tracking-[0.22em] text-amber-200 lg:text-[10px]">
              Why Aether Exists
            </p>
            ...
            <p className="mt-12 text-sm font-semibold italic tracking-[0.16em] text-amber-100 lg:mt-9 lg:text-[12px]">
