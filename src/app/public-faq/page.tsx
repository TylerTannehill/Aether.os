...
const faqs = [
  ...
  ["Is Honest Abe AI?","Not today. Honest Abe is Aether's campaign strategy engine, purpose-built to interpret the operational reality of political campaigns. Rather than generating strategy like a chatbot, Abe follows campaign-specific logic to identify operational pressure, competing priorities, execution risks, and opportunities for better coordination. As Aether continues to evolve, future versions of Honest Abe may leverage artificial intelligence where it meaningfully improves the campaign experience. However, Abe's value has never depended on AI. It comes from understanding how campaigns operate and helping campaign teams focus on what matters most."],
